    ...
    <div className="info-cards-container">
      <FadeInOnScroll direction="right" delay={100}>
        <div className="info-card">
          ...
          <div className="card-badge" href="https://svuit.org/hub/">Available Now</div>
        </div>
      </FadeInOnScroll>
      ...
      <FadeInOnScroll direction="left" delay={200}>
        <div className="info-card" style={{marginLeft: '0.2rem'}}>
          ...
          <div className="card-badge" href="https://svuit.org/">Available Now</div>
        </div>
      </FadeInOnScroll>
      ...
      <FadeInOnScroll direction="right" delay={300}>
        <div className="info-card">
          ...
          <br />
          <div className="card-badge" href="https://svuit.org/awesome-UIT-projects/">Available Now</div>
        </div>
      </FadeInOnScroll>
    </div>
  );
