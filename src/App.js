        ...
        >
            ...
            >
              <h1
                ...
                style={{
                  ...
                  margin: "0",
                  backgroundImage:
                    "linear-gradient(90deg, #fff, #b388ff, #7c4dff)",
                  backgroundClip: "text",
          ...
          <FadeInOnScroll direction="up" delay={200}>
            ...
            >
              <button
                onClick={() =>
                  (window.location.href =
                    "https://svuit.org/mmtt/docs/contribute")
                }
                ...
                style={{
                  ...
                  transition: "all 0.3s ease",
                  boxShadow:
                    hoveredButton === "contribute"
                      ? "0 7px 20px rgba(0, 255, 199, 0.4)"
                      : "0 4px 15px rgba(0, 255, 199, 0.3)",
                  position: "relative",
                  overflow: "hidden",
                  zIndex: 1,
                  transform:
              ...
              <button
                onClick={() =>
                  (window.location.href = "https://svuit.org/mmtt")
                }
              ...
              >
                ...
                >
                  ...
                  <a
                    ...
                    style={{
                      color:
                        hoveredLink === "notify-footer" ? "#b388ff" : "#fff",
                      textDecoration: "none",
                      padding: "0.7rem 1.4rem",
                      fontSize: "0.9rem",
                      fontWeight: "500",
                ...
                <div
                  style={{
                    ...
                    bottom: 0,
                    background:
                      "radial-gradient(circle at 20% 30%, rgba(179, 136, 255, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(124, 77, 255, 0.1) 0%, transparent 50%)",
                    zIndex: -1,
                  }}
                />
                ...
                <div
                  style={{
                    ...
                    height: "1px",
                    background:
                      "linear-gradient(90deg, transparent, rgba(0, 255, 199, 0.5), transparent)",
                    zIndex: 1,
                  }}
                />
